...
public class DesignClanMembersListRecyclerAdapter extends RecyclerView.Adapter<DesignClanMembersListRecyclerAdapter.ViewHolder> {

    private List<ClanManageMembersList> repliesList;

    DesignClanMembersListRecyclerAdapter(List<ClanManageMembersList> repliesList) {
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        if (membersList.getIsUserAdmin()){
            ...
            viewHolder.ivRemoveUserAdmin.setVisibility(View.VISIBLE);
        } else if (membersList.getUserID() == 0){
            ...
            viewHolder.ivMakeUserAdmin.setVisibility(View.VISIBLE);
            viewHolder.ivRemoveUserAdmin.setVisibility(View.GONE);
        }
        ...
        viewHolder.ivRemoveUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //viewHolder.ivRemoveUser.setVisibility(View.GONE);
                //sendClanInviteChange(v, String.valueOf(membersList.getclanID()), membersList.getClanName(), "KICK", String.valueOf(membersList.getUserID()));
                showDeleteRequestDialog(v, viewHolder, String.valueOf(membersList.getclanID()), membersList.getClanName(), "KICK", String.valueOf(membersList.getUserID()));
        ...
        viewHolder.ivMakeUserAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                viewHolder.ivMakeUserAdmin.setVisibility(View.GONE);
                viewHolder.ivRemoveUserAdmin.setVisibility(View.VISIBLE);
                sendClanInviteChange(view, String.valueOf(membersList.getclanID()), membersList.getClanName(), "MAKEADMIN", String.valueOf(membersList.getUserID()));


            }
        });

        viewHolder.ivRemoveUserAdmin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                viewHolder.ivMakeUserAdmin.setVisibility(View.VISIBLE);
                viewHolder.ivRemoveUserAdmin.setVisibility(View.GONE);
                sendClanInviteChange(view, String.valueOf(membersList.getclanID()), membersList.getClanName(), "REMOVEADMIN", String.valueOf(membersList.getUserID()));
    ...
    private void showDeleteRequestDialog(final View view, final ViewHolder holder, final String clanID, final String clanName, final String method, final String userID) {
        ...
        builder.setMessage("Kick this Member?  Cannot be undone.");
    ...
    public void sendClanInviteChange(final View view, final String clanID, final String clanName, final String changeType, final String userTobeApprovedID){
        ...
        UpdateClanMembersRequest getClanList = new UpdateClanMembersRequest(userid, clanID, clanName, authToken, changeType, userTobeApprovedID, responseListener);
