...
public class GetClanGameListings extends StringRequest {
    ...
    public GetClanGameListings(String userID, String clanName, String authToken, Response.Listener<String> listener){
