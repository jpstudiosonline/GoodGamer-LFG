...
public class GetViewClanRequest extends StringRequest {
    ...
    public GetViewClanRequest(String clanName, String userName, String parentUserID, String authToken, Response.Listener<String> listener){
